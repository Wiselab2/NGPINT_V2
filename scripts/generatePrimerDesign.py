...
def createTranscriptomeFileForPrimerDesign(options,gene_info):
    ...
    for line_num,line in enumerate(fhr):
        ...
        #fhw.write(header+"in_frame_fusion_seq"+"\n")
